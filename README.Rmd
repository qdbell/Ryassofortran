...
R-release. The speed increase is not always important while simulating soil
carbon, but for model calibration purposes the Fortran-release is vastly
superior.
...
There are basic examples that shows you how to run the Fortran-version of YASSO using the package:
